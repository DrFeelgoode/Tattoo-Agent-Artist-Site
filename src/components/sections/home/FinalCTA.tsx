...
export function FinalCTA() {
  return (
    <section id="final-cta" className="relative overflow-hidden bg-gradient-to-b from-charcoal to-black px-4 py-24 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <h2 className="font-[family-name:var(--font-lobster)] text-4xl text-cream sm:text-5xl md:text-6xl">
